...
import com.example.AI.basicgraph.Graph;
import com.example.AI.geography.GeographicPoint;
import com.example.AI.geography.RoadSegment;
...
public class GraphLoader 
{
	...
	public static void loadRoadMap(String filename, Graph theGraph)
	{
		HashMap<GeographicPoint,List<LinkedList<RoadLineInfo>>> pointMap = 
        		buildPointMapOneWay(filename);
...
//           }
	...
	public static void loadGraph(String filename, Graph theGraph)
	{
		BufferedReader reader = null;
        try {
            String nextLine;
